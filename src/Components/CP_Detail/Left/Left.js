...
function Left() {
    ...
    const handleAdd = () => {
        if (number == 100) {
            alert('Để tránh tình trạng bom hàng web chúng tôi chỉ giới hạn số lượng 100');
        } else {
            setNumber((pre) => pre + 1);
        }
    };
                ...
                <div className={cx('right')}>
                    ...
                    <div className={cx('numbers')}>
                        ...
                        <div className={cx('wrapper-ipt')}>
                            <input placeholder="1" type="text" value={number} />
                        </div>
                        <div onClick={() => handleAdd()} className={cx('add')}>
                            <AddIcon />
                        </div>
            ...
            <div className={cx('description')}>
                ...
                <div className={cx('contents')}>
                    <div ref={content1Ref} className={cx('content', 'content-1')} style={{ display: 'inline-block' }}>
                        <div className={cx('title ')}>
                            Nike Air Jordan 14 Retro là biểu tượng của sự kết hảo giữa tốc độ vượt trội và phong cách
                            đẳng cấp. Đôi giày sneaker này sở hữu gam màu Light Ginger, Trắng và Đen tạo nên vẻ ngoài
                            táo bạo và độc đáo, thu hút sự chú ý bất kỳ nơi nào bạn đến. Được chế tạo với tinh tế và sự
                            chú ý đến từng chi tiết, đôi giày này có phần trên màu da lộn màu vàng với điểm nhấn màu
                            đen, tạo thêm độ sâu và sự tinh tế cho thiết kế. Đế trắng không chỉ phù hợp với gam màu mà
                            còn mang lại độ bám và độ bền vượt trội. Thiết kế cho sự thoải mái tối đa, Nike Air Jordan
                            14 Retro tích hợp công nghệ đệm khí Air của Nike, mang đến sự đàn hồi và êm ái mỗi bước đi.
                            Gối đệm cổ chân và lưỡi gà đệm cung cấp sự hỗ trợ bổ sung cho mắt cá chân và giữ chân vững
                            chắc, an toàn. Cho dù bạn đang đi dạo trên phố hay thi đấu trên sân bóng rổ, đôi giày này
                            được thiết kế để biểu diễn. Vật liệu nhẹ và thoáng khí giúp giữ cho đôi chân mát mẻ và khô
                            ráo, trong khi chất liệu chắc chắn có thể chịu đựng những hoạt động gay gắt. Nổi bật khác
                            biệt và thể hiện phong cách độc đáo của bạn với đôi giày Nike Air Jordan 14 Retro. Sở hữu
                            ngay đôi giày này và trải nghiệm sự kết hợp hoàn hảo giữa thời trang và tính năng.
                        </div>
                    </div>
